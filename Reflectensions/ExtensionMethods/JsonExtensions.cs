...
//        public static JObject AddPath(this JObject jObject, string path, object value) {
//            try {
//                var paths = Parser.ParseCSVLine(path.Trim('.'), '.');
//                var p = paths.FirstOrDefault();
//                if (paths.Length > 1) {
//                    if (jObject.Property(p) == null) {
//                        var jo = new JObject().AddPath(string.Join(".", paths.Skip(1)), value);
//                        jObject.Add(p, jo);
//                    } else {
//                        if (jObject[p].Type == JTokenType.Object) {
//                            ((JObject)jObject[p]).AddPath(string.Join(".", paths.Skip(1)), value);
//                        } else {
//                            jObject[p] = new JObject().AddPath(string.Join(".", paths.Skip(1)), value);
//                        }
//                    }
//                } else {
//                    if (value == null) {
//                        jObject.Add(p, null);
//                    } else {
//                        jObject.Add(p, JToken.FromObject(value));
//                    }
